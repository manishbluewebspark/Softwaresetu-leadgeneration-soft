  ...
  return (
    <div className="p-6 bg-gray-50">
      ...
      {Object.keys(groupedData) .sort((a, b) => {
        ...
        const filteredRows = groupedData[date].filter((item) =>
            ...
            <table className="w-full text-sm border-collapse table-fixed">
              <thead className="bg-gray-50">
                <tr className="border-b">
                  <th className="border px-3 py-2 text-left w-18">Name</th>
                  ...
                  <th className="border px-3 py-2 text-left w-18">Assigned To</th>
                  <th className="border px-3 py-2 text-left w-18">Status</th>
                </tr>
              </thead>
              <tbody>
                {filteredRows.map((item, idx) => (
                  <tr key={idx} className="border-b bg-white">
                    <td className="border px-3 py-2 w-30">{item.name}</td>
                    <td className="border px-3 py-2 w-28">{item.mobile}</td>
                    ...
                    <td className="border px-3 py-2 w-80">
